...
def get_user_settings(default_settings):
    ...
    """
    app_name = "MyAwesomeApp"  # Replace with your app's name
    try:
...
def get_user_setting_value(key, default_value=None):
    ...
    """
    default_settings = {"theme": "light", "language": "en", "volume": 0.5}
...
user_settings = get_user_settings(default_settings)
print("1 Loaded settings:", user_settings)

# Modify some settings:
user_settings = get_user_settings({"theme": "dark", "language": "fr", "volume": 0.7})
save_user_settings(user_settings) # Save the modified settings

print("Settings saved.")

# Load them again to check:
loaded_again_settings = get_user_settings({"theme": "dark", "language": "en", "volume": 0.5})
theme_value = loaded_again_settings.get("theme", "default_theme")
print("Theme value:", theme_value)
print("2 Loaded again settings:", loaded_again_settings)

# Get the value of a specific key
theme_value = get_user_setting_value("theme", "default_theme")
print("Theme value:", theme_value)

# Save a specific key-value pair
save_user_setting_value("theme", "light")
print("Updated theme value to 'light'.")

# Verify the update
updated_theme_value = get_user_setting_value("theme", "default_theme")
print("Updated theme value:", updated_theme_value)
